...
declare const theme: string & {
    ...
    colors: {
        ...
        iToddy300: _stitches_react_types_theme.Token<"iToddy300", string, "colors", "">;
        iToddy500: _stitches_react_types_theme.Token<"iToddy500", string, "colors", "">;
        iToddy700: _stitches_react_types_theme.Token<"iToddy700", string, "colors", "">;
        iToddy900: _stitches_react_types_theme.Token<"iToddy900", string, "colors", "">;
    };
    fontSizes: {
...
declare const createTheme: <Argument0 extends string | ({
    colors?: {
        ...
        iToddy300?: string | number | boolean | undefined;
        iToddy500?: string | number | boolean | undefined;
        iToddy700?: string | number | boolean | undefined;
        iToddy900?: string | number | boolean | undefined;
    } | undefined;
    fontSizes?: {
...
export { Avatar, AvatarProps, Box, BoxProps, Button, ButtonProps, Checkbox, CheckboxProps, Heading, HeadingProps, MultiStepProps, Multistep, Text, TextArea, TextAreaProps, TextInput, TextInputProps, TextProps, config, createTheme, css, getCssText, globalCss, keyframes, styled, theme };
